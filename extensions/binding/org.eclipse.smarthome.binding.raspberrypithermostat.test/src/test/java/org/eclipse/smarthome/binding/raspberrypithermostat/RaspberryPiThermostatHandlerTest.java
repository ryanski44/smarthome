...
/**
 * Test cases for {@link RaspberryPiThermostatHandler}. The tests provide mocks for supporting entities using Mockito.
 *
 * @author Ryan Adams - Initial contribution
 */
public class RaspberryPiThermostatHandlerTest extends JavaTest {
    ...
    public void setUp() {
        initMocks(this);
        handler = new RaspberryPiThermostatHandler(thing);
